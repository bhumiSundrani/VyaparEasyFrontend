...
const MobileCardCell: React.FC<MobileCardCellProps> = ({ purchase, handlePurchaseDeleted, setPurchase }) => {
  ...
  const handleDelete = async () => {
    try {
      ...
      await axios.delete(`${process.env.NEXT_PUBLIC_SERVER_URL}/api/purchases/${purchase._id}`, {withCredentials: true});
  ...
  const handlePaid = async () => {
    try {
      ...
      const res = await axios.put(`${process.env.NEXT_PUBLIC_SERVER_URL}/api/purchases/${purchase._id}`, {}, {withCredentials: true});
